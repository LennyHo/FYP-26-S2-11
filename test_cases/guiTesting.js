...
describe("GUI testing", function () {
  ...
  it("shows the shopping cart heading in the cart component", function () {
    const source = readFrontendFile("view/app/components/Cart.tsx");

    expect(source).to.include("Your Shopping Cart");
  });
  ...
  it("has a header cart button that navigates to cart", function () {
    const source = readFrontendFile("view/app/components/Header.tsx");
  ...
  it("has login form fields and a sign in button", function () {
    const source = readFrontendFile("view/app/login/page.js");
  ...
  it("has an accessible Avy chat open button", function () {
    const source = readFrontendFile("view/app/components/GlobalLayout.tsx");
