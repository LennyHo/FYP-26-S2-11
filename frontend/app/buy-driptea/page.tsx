      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.heroCopy}>
            ...
            <div className={styles.actions}>
              <a className={styles.primaryAction} href="/cart">
                View Cart
              </a>
              <a className={styles.secondaryAction} href="/our-story">
                Read Our Story
              </a>
            </div>
          ...
          <div className={styles.cardGrid}>
            {products.map((product) => (
              <article key={product.name} className={`${styles.productCard} ${styles[product.tone]}`}>
                ...
                <h3>{product.name}</h3>
                <p>{product.note}</p>
                <a href="/cart" className={styles.cardLink}>
                  Add to cart
                </a>
              </article>
            ))}
        ...
        <section className={styles.splitSection}>
          ...
          <div className={styles.offerPanel}>
            ...
            <a href="/cart" className={styles.offerAction}>
              Go to cart
            </a>
          </div>
        </section>
